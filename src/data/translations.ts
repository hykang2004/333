export const translations = {
  ko: {
    ...
    hero: {
      ...
      storySnippet: '사고뭉치 마법사들의 실수로 깨진 물약! 퍼져나가는 보라빛 수증기와 정체불명의 저주를 막기 위해 조수 마법사는 깜냥이와 함께 원소를 수집해야 합니다.',
    ...
    booths: {
      ...
      catDayTip: '페이스페인팅이랑 양말목 키링 만들기는 꼭 체험해봐야 한다냥! 🐾',
    ...
    liveTalk: {
      ...
      btnSend: '전송',
      quickCheers: ['ZEST 무대 레전드다 🔥', '태권도 격파 쾌감 대박 🥋', '23:00 상품추첨 대박 🎁', '깜냥이 너무 귀여워 🐾', '개화 총동연 파이팅 🌸'],
  ...
  en: {
    ...
    hero: {
      ...
      storySnippet: 'Mischievous apprentice wizards accidentally broke the sacred potion! Gather magical elements across campus with mascot cat Kkamnyangi to save the night!',
    ...
    booths: {
      ...
      nightTab: '🌙 Night Booths (18:00 ~ 23:15)',
      ...
      catDayTip: 'Make sure to try face painting and cute sock-yarn keychains! 🐾',
    ...
    tarot: {
      ...
      subtitle: 'Draw your destiny element with Kkamnyangi and get custom booth pairings',
      ...
      recommendedBoothTitle: 'Kkamnyangi’s Matched Booth',
    ...
    liveTalk: {
      ...
      btnSend: 'Send',
      quickCheers: ['Zest stage is legendary 🔥', 'Taekwondo board break was sick 🥋', 'Lucky draw at 23:00 🎁', 'Kkamnyangi is so cute 🐾', 'Gaehwa Club Assoc fighting 🌸'],
